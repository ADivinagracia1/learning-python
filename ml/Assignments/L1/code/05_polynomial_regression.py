...
print(f"Performance of 5th order polynomial regression model for TEY: R2 = {r2_TEY_5}, RMSE = {rmse_TEY_5}")
print(f"Performance of 11th order polynomial regression model for TEY: R2 = {r2_TEY_11}, RMSE = {rmse_TEY_11}")
